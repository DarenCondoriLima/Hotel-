...
public class ReservasView2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReservasView2 frame = new ReservasView2();
	 ...
	 * Create the frame.
	 */
	public ReservasView2() {
		super("Reserva");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView2.class.getResource("/imagenes/aH-40px.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView2.class.getResource("/imagenes/Ha-100px.png")));

		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView2.class.getResource("/imagenes/reservas-img-3.png")));
		...
		txtFechaEntrada.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView2.class.getResource("/imagenes/icon-reservas.png")));
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (ReservasView2.txtFechaEntrada.getDate() != null && ReservasView2.txtFechaSalida.getDate() != null) {
